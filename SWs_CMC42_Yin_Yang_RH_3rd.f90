program SWs_CMC42_Yin_Yang_RH_3rd
!********************************************************************************
...
!********************************************************************************
implicit none
integer,parameter::nx=256,ny=(nx/2)+1,n_epsilon_x=nx/8,n_epsilon_y=(ny-1)/8&
,mx=(3*nx/4)+2*n_epsilon_x,my=((ny-1)/2)+1+2*n_epsilon_y,kky=2*(ny-1),kkx=nx/2,days=12
...
,u1ein(nx,ny),v1ein(nx,ny),henee(nx,ny)&
,u1(nx,ny),v1(nx,ny)
...
,u1n(mx,my),v1n(mx,my),u1e(mx,my),v1e(mx,my)&
...
call RK_init_swe(u1n,v1n,hen1,dunx,duny,dvnx,dvny,dhnx,dhny,mx,my,a2,hun1,hvn1,hhn1,hhun1,hhvn1&
,hhhn1,pn,fon,delt,u1n,v1n,hen1)


!Yang component

call RK_init_swe(u1e,v1e,hee1,duex,duey,dvex,dvey,dhex,dhey,mx,my,a2,hue1,hve1,hhe1,hhue1,hhve1,hhhe1&
,pe,foe,delt,u1e,v1e,hee1)
...
call RK_init_swe(u1n,v1n,hen1,dunx,duny,dvnx,dvny,dhnx,dhny,mx,my,a3,hun2,hvn2,hhn2,hhun2,hhvn2,hhhn2&
,pn,fon,delt,hhun1,hhvn1,hhhn1)

!Yang component

call RK_init_swe(u1e,v1e,hee1,duex,duey,dvex,dvey,dhex,dhey,mx,my,a3,hue2,hve2,hhe2,hhue2,hhve2,hhhe2&
...
call RK_init_swe(u1n,v1n,hen1,dunx,duny,dvnx,dvny,dhnx,dhny,mx,my,a4,hun3,hvn3,hhn3,hhun3,hhvn3,hhhn3&
,pn,fon,delt,hhun2,hhvn2,hhhn2)
...
call RK_init_swe(u1n,v1n,hen1,dunx,duny,dvnx,dvny,dhnx,dhny,mx,my,a4,hun4,hvn4,hhn4,hhun4,hhvn4,hhhn4&
...
call RK_init_swe(u1e,v1e,hee1,duex,duey,dvex,dvey,dhex,dhey,mx,my,a4,hue4,hve4,hhe4,hhue4,hhve4,hhhe4&
,pe,foe,delt,hhue3,hhve3,hhhe3)
...
end program SWs_CMC42_Yin_Yang_RH_3rd
!**************************************************************************
!**************************************************************************
!**************************************************************************
!**************************************************************************
